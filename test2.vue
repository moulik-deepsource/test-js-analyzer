<template>
  <div class="mx-auto h-screen w-screen text-vanilla-100 flex">
    <!-- Left Section -->
    <div
      class="w-full xl:w-7/12 bg-ink-400 flex flex-col justify-center items-center"
    >
      <div
      ...
      >
        ...
        <div class="h-full flex flex-col gap-y-6 w-full">
          ...
          <!-- List of Issue Types-->
          <div
            class="w-full pb-12 md:pb-0 grid grid-cols-1 md:grid-cols-2 auto-rows-max gap-6 sm:gap-2.5"
          >
          ...
          <div class="fixed md:static bottom-0 w-full left-0">
            <z-button color="primary" class="w-full"
              >Save configuration and proceed</z-button
            >
          </div>
        </div>
      </div>
